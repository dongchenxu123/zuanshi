...
class LikeMyDirection extends React.Component {
  constructor () {
    super()
    this.state={
      searchkw: '',
  ...
  componentWillMount () {
    var select = this.props.data.likeMybobyDirection.select
    var searchkw = this.props.data.likeMybobyDirection.searchkw
    if(select && searchkw != '') {
...
export default LikeMyDirection
=======
import React from 'react';
import axios from 'axios';
import { getShopitems } from '../../help/url';
